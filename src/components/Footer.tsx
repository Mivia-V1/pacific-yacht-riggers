  ...
  return (
    <footer className="bg-navy-950 text-navy-300 pb-24 lg:pb-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-2 gap-x-8 gap-y-10 lg:gap-x-16">
          {/* Brand */}
          <div className="col-span-2 text-center">
            <Link
              href="/"
              className="inline-flex items-start justify-center gap-3"
            >
          ...
          {/* Contact */}
          <div className="col-span-2 border-t border-navy-800 pt-8 text-center">
            <h4 className="text-white font-semibold text-sm uppercase tracking-wider mb-4">
              Contact
            </h4>
            <ul className="flex flex-col items-center justify-center gap-3 text-sm sm:flex-row sm:flex-wrap sm:gap-x-8">
              <li>
                <a
                  href={CONTACT.phoneHref}
                  className="flex items-center justify-center gap-2 transition-colors hover:text-teal-400"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
